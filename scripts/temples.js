...
const temples = [
    ...
    },
    {
        ...
        area: 48100,
        imageUrl: "https://content.churchofjesuschrist.org/templesldsorg/bc/Temples/photo-galleries/campinas-brazil/204x170/campinas-brazil-temple-lds-187032-wallpaper.jpg"
    },
    {
...
function createTempleCard(filteredTemples) {
    ...
    gallery.innerHTML = ""; // Clears the gallery before rendering new cards

    filteredTemples.forEach(temple => {
        let card = document.createElement("figure");

        // Use template literals to construct the inner HTML cleanly
        card.innerHTML = `
...
// Initial Call to show all temples on page load
...
document.querySelector("#old").addEventListener("click", (e) => {
    e.preventDefault();
    // Splits the string "1888, May, 21" into an array, grabs the first item "1888", converts to a number, and checks if it's less than 1900
